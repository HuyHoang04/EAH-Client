          ...
          <div className="bg-white/95 backdrop-blur-xl p-10 rounded-2xl shadow-2xl border border-white/20">
                  ...
                  <button
                    ...
                    className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white ${
                      isSubmitting 
                        ...
                        : 'bg-black hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black-500'
            ...
            <div className="text-sm text-center mt-6">
              <p className="text-gray-600">
                ...
                <Link href="/terms" className="text-blue-600 font-medium hover:text-blue-500">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy" className="text-blue-600 font-medium hover:text-blue-500">
                  Privacy Policy
                </Link>
              </p>
            </div>
